...
create table BILLRUN (ID int unsigned not null auto_increment, CUSTOMERID varchar(20), BILLRUNENDDATE varchar(20),primary key(ID)) engine=innodb default charset=utf8 auto_increment=1;